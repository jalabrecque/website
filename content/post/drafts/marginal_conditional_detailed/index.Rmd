...
#### 1) Effects within one stratum

The first is the effect within a subgroup: 

$$ E[Y^{A=1}-Y^{A=0}|Sex=F] $$

The above estimand is a conditional effect in that it is the effect of $A$ on $Y$ only within those with $Sex=F$. So, conditional on being a woman, this is the causal effect.
...
Hopefully this brings someone some clarity about all this. Let me know if it hasn't.
