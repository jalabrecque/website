---
title: "What to do when you have unmeasured confounding (which is always)"
...
- [Life doesn't make sense!](https://www.youtube.com/watch?v=OyDpS-GftCk)

Before I begin talking about fancier things, I need to make sure we're all on the same page with regards to causal inference and causal assumptions. Here are the slides

- Inventing causal assumptions (20 minute group exercise)
...
- [Triangulation in aetiological epidemiology](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5841843/). Lawlor, Tilling and Davey Smith, 2016.
- [Alternative causal inference methods in population health research: Evaluating tradeoffs and triangulating evidence](https://www.sciencedirect.com/science/article/pii/S2352827319301545). Matthay et al, 2020.
